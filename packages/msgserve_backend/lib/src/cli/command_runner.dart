...
import 'package:msgserve_backend/src/cli/http_command.dart';
import 'package:msgserve_backend/src/cli/serve_command.dart';
import 'package:msgserve_backend/src/cli/version_command.dart';
...
class MainCommandRunner extends CommandRunner<void> {
  MainCommandRunner() : super('msgserv_backend', 'Backend server') {
    this
      ..argParser.addFlag(
        ARG_QUIET,
        abbr: 'q',
